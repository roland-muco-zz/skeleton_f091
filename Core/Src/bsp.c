...
/**
 * \brief show use of MCO, like having a clock signal of 8MHz from the internal HSI source	
 */
void bsp_set_mco_8mhz_pa8(void) 
{
	...
	**/
	...
	/* output the selected clock source to the PA8 output along with the divider */
